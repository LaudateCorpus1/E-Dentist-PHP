        ...
        <div class="input-group">
            ...
            <div class="input-group-btn">
                ...
                <table class="table table-striped table-bordered">
                  ...
                  <?php
 $selektimi = "SELECT u.user_id, u.name, u.surname, t.date, t.time, u.email, t.id_termini, u.username FROM user AS u INNER JOIN termini AS t ON u.user_id=t.id_users WHERE t.date >='".$date."' AND u.username LIKE '".$_SESSION['username']."'  ORDER BY `t`.`date` ASC, t.time ASC";
