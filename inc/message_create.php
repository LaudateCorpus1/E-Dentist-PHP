...
<form id="message_form" method="POST" action = "message_insert.php" onsubmit="return validateMessageForm();" >
      ...
      <div class="form-group">
          <label class="required" for="username">Dentisti:</label>
     <?php

    $query = "SELECT user_id, name, surname, username FROM user WHERE admin=1";
    $result = mysql_query ($query);
    echo "<select value='' class='form-control' id='username' name='username'><option>Dentisti</option>";
    ...
    <a class="btn btn-default" href="../?faqe=message"><span class="glyphicon glyphicon-chevron-left">&thinsp;</span>Kthehu</a>
  </form>
 ...
 <div class="col-sm-6">
  ...
  <li class="list-group-item"> <p>Zgjedhni Dentistin qe deshironi te ia dergoni mesazhin.</p> </li>
