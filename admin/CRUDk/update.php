        ...
        <span class="icon-bar"></span>
		   ...
		   <ul class ="nav navbar-nav">
                    ...
                    <li><a href="../?admin=userat" class="hvr-underline-from-left" id="links">PERDORUESI</a></li>
                     <li><a href="../?admin=keshillat" class="hvr-underline-from-left"id="active">KESHILLA </a></li>
...
echo "<option value=".$path ."> ".$name[3]." </option>"; 
    ...
    <button type="submit" value="Submit" form ="keshilla_form"class="btn btn-success"><span class="glyphicon glyphicon-ok">&thinsp;</span>Ndrysho</button>
